...
function EditProfile(props) {
  ...
  const handleUpdataProfile = async () => {
    ...
    const updateUserInfoResponse = await updateUserInfoToBackend({
      firstName,
      lastName,
      email,
      phoneNumber,
    ...
    console.log(
      "after updating user info backend sent this ",
  ...
  return (
    <>
      ...
      <div className="edit-profile-wrapper">
        ...
        <div className="container edit-profile-cta-container">
          <div className="d-flex justify-content-end mb-4 edit-profile-cta-container">
            <button
              type="button"
              className="col-5 col-md-2 btn btn-secondary mx-1 cta-btn-edit-profile"
            >
              Cancel
            </button>
            <button
              type="button"
              className="col-5 col-md-2 btn mx-1 cta-btn-edit-profile"
