...
if (cluster.isMaster) {
  ...
  // Dynamically assign a port for each worker
        ...
        app.put(`/api/basePrice`, (req, res) => {
            ...
            if (decoded) {
                try {
                    ...
                    else if (houseType == "1bhk") {if (totalDistance <= 5) {basePrice = 3199;}
        ...
        app.post(`/api/payment`, async (req, res) => {
            ...
            if (decoded) {
                ...
                if (isSuccess) {
                    ...
                    q28 = "UPDATE payments SET transaction_id = '" + merchantTransaction + "', merchant_user = '" + merchantUser + "', total_amount = '"+ totalAmt +"', initial_payment_code = '" + code + "', initial_payment_response = '" + payRes + "' WHERE user_mobile = '" + mobileNumber + "' AND order_id = '" + OrderID + "' ";
