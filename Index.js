...
app.get('/login', (req, res) => {
    ...
    con.query(q8, (error, result) => {
        ...
        if (result.rows.length > 0) {
            q12 = "SELECT user_password FROM userInfo WHERE user_password = '"+password+"'";
    ...
    app.put('/inventory', (req, res) => {
        ...
        q21 = "UPDATE userInventory SET user_inventory='" + req.body.user_inventory + "', event_date='" + req.body.dataTime.selectedDay.date + "', event_time='" + req.body.dataTime.selectedTime.label + "', addons='" + req.body.addons + "' WHERE user_mobile='" + mobile + "'";
